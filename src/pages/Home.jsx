    ...
    <div className="home-container">
      ...
      <section className="introduction">
        <div className="introduction-text">
          ...
          <p>
            ...
            de films, séries et documentaires. Découvrez des trésors cachés et créez
      ...
      <section id="about" className="about">
        ...
        <p>
          ...
          genres et de toutes époques. Que vous soyez fan d'horreur, de comédie, de
          drame ou de science-fiction, nous avons quelque chose pour vous.
        </p>
      </section>
      ...
      <section id="features" className="features">
        ...
        <div className="features-grid">
          <div className="feature">
            ...
            <p>
              Filtrez les films par genre, année, popularité et bien plus encore.
            </p>
          </div>
          <div className="feature">
            <h3>Listes Personnalisées</h3>
            <p>
              Créez et partagez vos propres listes de films avec vos amis.
            </p>
          </div>
          <div className="feature">
